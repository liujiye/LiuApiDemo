 ...
 */
@Entity
public class ShopGreenDao extends GsonObj<ShopGreenDao>
{
    //表示为购物车列表
    ...
    @Generated(hash = 1130479867)
    public ShopGreenDao(Long id, String name, String price, int sell_num,

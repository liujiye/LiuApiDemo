...
/**
 * 简单的RecyclerView Adapter例子
 */
public class SimpleRecyclerAdapter extends Adapter<SimpleRecyclerAdapter.ViewHolder>
        implements View.OnClickListener
{
     ...
     * @Description: TODO
     */
    public SimpleRecyclerAdapter(List<String> dataset)
    {
        mDataset = dataset;
    }
